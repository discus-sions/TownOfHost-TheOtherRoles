...
namespace TownOfHost
{
    ...
    class CanUseVentPatch
    {
            ...
            ref float __result)
        {
            ...
            else if (pc.Object.Is(CustomRoles.Sheriff) || pc.Object.Is(CustomRoles.Amnesiac) || (pc.Object.Is(CustomRoles.Arsonist) && !pc.Object.IsDouseDone() && !Options.TOuRArso.GetBool()))
                return false;
