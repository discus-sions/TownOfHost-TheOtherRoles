...
namespace TownOfHost
{
    public class AdminPatch
    {
        ...
        public static bool DisableArchiveAdmin => Options.DisableAdmin.GetBool() && GameOptionsManager.Instance.currentNormalGameOptions.MapId == 4 && Options.WhichDisableAdmin.GetString() == GetString(Options.whichDisableAdmin[1]);
