    ...
    class ChanceChangePatch
    {
        public static void Postfix(RoleOptionSetting __instance)
        {
            ...
            if (__instance.Role.Role == RoleTypes.Shapeshifter)
            {
                ...
                if (CustomRoles.SerialKiller.IsEnable() || CustomRoles.Warlock.IsEnable() || CustomRoles.Camouflager.IsEnable() || CustomRoles.TheGlitch.IsEnable() || CustomRoles.BountyHunter.IsEnable()/* || CustomRoles.ShapeMaster.IsEnable()*/) forced = true;
            }
