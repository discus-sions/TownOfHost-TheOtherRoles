...
namespace TownOfHost
{
    ...
    {
        private static readonly string URL = "https://api.github.com/repos/music-discussion/TownOfHost-TheOtherRoles";
        ...
        {
            string url = beta ? BetaBuildURL : URL + "/releases/latest";
            try
            {
                string result;
