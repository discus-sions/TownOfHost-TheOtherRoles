...
namespace TownOfHost
{
    ...
    {
        public static int CheckPercentage(string str = "", byte playerId = 0xff, bool noErr = false)
        {
            ...
            {
                if (playerId == 0xff)
                    HudManager.Instance.Chat.AddChat(PlayerControl.LocalPlayer, "The file was not found. Download the file for percentages to work correctly.");
                else Utils.SendMessage("The file was not found. Please alert the host.", playerId);
                return 0;
            }
